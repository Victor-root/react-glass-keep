...
loginUnexpectedError: "Impossible de se connecter. Vérifiez votre réseau et réessayez.",
  ...
  readModeOptionDesc: "Activé : les notes texte et dessin s'ouvrent en lecture seule — évite les modifications involontaires, pas de curseur clignotant, idéal pour relire. Désactivé : les notes s'ouvrent directement en édition, pratique si tu modifies souvent tes notes (style Google Keep).",
  exitDrawMode: "Quitter le dessin",
  sidebarBreakpoint: "Taille d'écran minimale",
  sidebarBreakpointDesc: "À partir de quelle largeur d'écran la barre latérale reste affichée. Si elle prend trop de place chez toi, choisis une valeur plus grande.",
