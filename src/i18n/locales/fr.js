...
loginUnexpectedError: "Impossible de se connecter. Vérifiez votre réseau et réessayez.",
  ...
  restartServerConfirm: "Le service sera brièvement hors ligne.",
  restartServerInProgress: "Redémarrage en cours",
  shutdownServer: "Éteindre le serveur",
  shutdownServerTitle: "Éteindre le serveur ?",
  shutdownServerConfirm: "Le service sera arrêté. Vous devrez le relancer manuellement.",
  shutdownServerConfirmBtn: "Éteindre",
  ...
  sidebarBreakpoint1024: "Tablette en paysage (≥ 1024 px)",
  sidebarBreakpoint1280: "Petit laptop / standard (≥ 1280 px) — recommandé",
  sidebarBreakpoint1366: "Laptop 14 pouces (≥ 1366 px)",
  sidebarBreakpoint1440: "Laptop 15 pouces (≥ 1440 px)",
  sidebarBreakpoint1600: "Grand écran de bureau (≥ 1600 px)",
  name: "Nom",
  ...
  workspaceThemeDesc: "Recolore le header, la sidebar et le fond. Les notes ne changent pas.",
  workspaceThemeSaveError: "Impossible d'enregistrer le thème sur le serveur — il s'applique sur cet appareil.",
  ...
  customLogoDesc: "Affiché sur l'écran de connexion et dans l'en-tête. PNG, JPG ou WebP, jusqu'à 2 Mo.",
  customLogoRecommend: "Recommandé : image carrée, 512×512 px (un PNG transparent est idéal).",
  ...
  brandingResetHint: "Laisser vide pour conserver la valeur par défaut.",
  brandingImageTooLarge: "L'image est trop volumineuse.",
  brandingInvalidFormat: "Format non supporté. Utilisez PNG, JPG ou WebP.",
  brandingLogoUpdated: "Logo mis à jour",
  ...
  yes: "Oui",
  no: "Non",
  deleteUserConfirm: "Supprimer définitivement {name} ({email}) ? Toutes ses notes et données seront retirées et cette action est irréversible.",
  userDeletedNotifTitle: "Utilisateur supprimé",
  userDeletedNotifMessage: "{name} a été supprimé par {admin}",
  userDeletedToast: "{name} a été supprimé",
  ...
  pendingUserNotifTitle: "Nouvelle inscription",
  pendingUserNotifMessage: "{name} ({email}) souhaite créer un compte",
  pendingUserAlreadyHandled: "Cette demande a déjà été traitée par un autre administrateur",
  ...
  noteAccessRevokedWithCopyToast:
    "{sender} vous a retiré l'accès à la note {title}, mais une copie vous a été conservée",
  collaboratorRemovedTitle: "Collaborateur retiré",
  ...
  notifFallbackSuccess: "Succès",
  notifFallbackWarning: "Attention",
  notifFallbackError: "Erreur",
  ...
  notificationsSoundTypesLabel: "Options de son par catégorie",
  soundTypeShare: "Notes partagées",
  soundTypeAccess: "Changements d'accès",
  soundTypeSuccess: "Réussites (sauvegarde, archivage, corbeille, restauration…)",
  soundTypeWarning: "Avertissements",
  soundTypeError: "Erreurs",
  soundTypeInfo: "Messages d'information",
  notificationsDurationTitle: "Durée par défaut",
  notificationsDurationDesc: "Combien de temps une notification reste affichée avant de disparaître",
  notifDurSeconds: "{n} s",
  ...
  passkeyNamePrompt: "Donnez un nom à votre clé d'accès pour la reconnaître plus tard.",
  passkeyNamePlaceholder: "Téléphone, YubiKey…",
  passkeyRenamePrompt: "Choisissez un nouveau nom :",
  passkeyDeleteTitle: "Supprimer la clé d'accès ?",
  passkeyDeleteConfirm: "Cette clé d'accès ne pourra plus être utilisée pour se connecter. Si elle servait aussi à déverrouiller l'instance, ce droit sera également supprimé.",
  ...
  qrLoginWaiting: "En attente du scan…",
  qrLoginExpiresIn: "expire dans %ss",
  qrLoginApproved: "Approuvé ! Connexion en cours…",
  qrLoginRejected: "La connexion a été refusée depuis le téléphone.",
  qrLoginExpired: "Ce QR code a expiré. Générez-en un nouveau.",
  qrLoginError: "Impossible de générer le QR code. Vérifiez la connexion au serveur.",
  qrLoginRegenerate: "Générer un nouveau QR",
  qrSignInRowTitle: "Connecter un autre appareil",
  qrSignInRowSubtitle: "Touchez pour scanner le QR code affiché sur l'écran de connexion d'un autre PC et l'authentifier.",
  qrSignInQuickToggleLabel: "Raccourci dans l'en-tête (mobile)",
  ...
  qrScanFetching: "Vérification…",
  qrScanApproving: "Approbation en cours…",
  qrScanApproved: "Appareil connecté",
  qrScanApprovedBody: "L'autre appareil est maintenant authentifié.",
  qrScanError: "Une erreur est survenue",
  qrScanReject: "Refuser",
  qrScanApprove: "Approuver",
  qrScanFieldBrowser: "Navigateur",
  qrScanFieldOs: "Système",
  qrScanFieldIp: "IP",
  qrScanWrongOrigin: "QR code étranger",
  qrScanWrongOriginBody: "Ce QR pointe vers %s — il ne provient pas de votre serveur GlassKeep. Connexion refusée par sécurité.",
  qrScanRetry: "Fermer",
  ...
  audioPlay: "Lecture",
  audioPause: "Pause",
  audioProgressLabel: "Progression audio",
  audioDuration: "Durée",
